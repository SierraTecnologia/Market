...
class CreateFeaturesCommercesTables extends Migration
{
    ...
    {
        Schema::create(
            config('siravel.db-prefix', '').'product_variants', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            config('siravel.db-prefix', '').'cart', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            config('siravel.db-prefix', '').'transactions', function (Blueprint $table) {
                $table->increments('id');
                $table->string('uuid');
                $table->integer('user_id');
        ...
        Schema::create(
            config('siravel.db-prefix', '').'orders', function (Blueprint $table) {
                $table->increments('id');
                $table->string('uuid');
                $table->integer('user_id');
        ...
        Schema::create(
            config('siravel.db-prefix', '').'plans', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            config('siravel.db-prefix', '').'favorites', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            config('siravel.db-prefix', '').'coupons', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            config('siravel.db-prefix', '').'order_items', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            config('siravel.db-prefix', '').'refunds', function (Blueprint $table) {
                $table->increments('id');
