...
class ApiController extends SitecController
{
    ...
    public function __construct(Request $request)
    {
        ...
        if (! empty($this->modelName)) {
            ...
            if (class_exists('Market\Models\\'.$this->getFeature($this->modelName).'\\'.ucfirst($this->modelName))) {
                $this->model = app('Market\Models\\'.$this->getFeature($this->modelName).'\\'.ucfirst($this->modelName));
            } else {
