                ...
                @else
                    <table class="table table-sitecpaymentd">
                        ...
                        @foreach($orders as $order)
                            <tr>
                                <td><a href="{!! route('master.market.orders.edit', [$order->id]) !!}">Order #{!! $order->id !!}</a></td>
                                <td class="m-hidden"><a href="{!! route('master.market.transactions.edit', [$order->transaction->id]) !!}">Transaction #{!! $order->transaction->id !!}</a></td>
                                ...
                                <td class="text-right">
                                    <a class="btn btn-sm btn-outline-primary float-right" href="{!! route('master.market.orders.edit', [$order->id]) !!}"><i class="fa fa-edit"></i> Edit</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
