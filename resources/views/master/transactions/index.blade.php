...
@section('content')
    ...
    @include('market::layouts.module-header', [ 'module' => 'transactions' ])

    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                @if ($transactions->isEmpty())
                    @include('market::layouts.module-search', [ 'module' => 'transactions' ])
                @else
                    <table class="table table-sitecpaymentd">
                        ...
                        @foreach($transactions as $transaction)
                            <tr>
                                <td><a href="{!! route('master.market.transactions.edit', [$transaction->id]) !!}">
                                ...
                                <td class="text-right">
                                    <a class="btn btn-sm btn-outline-primary float-right" href="{!! route('master.market.transactions.edit', [$transaction->id]) !!}"><i class="fa fa-edit"></i> Edit</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
